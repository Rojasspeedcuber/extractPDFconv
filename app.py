...
tab_participacao, tab_extracao = st.tabs(
    ["🗳️ Participação nas Eleições", "📄 Extração de Carta Convocatória"]
)

# --- ABA 1: COMPROVAÇÃO DE PARTICIPAÇÃO E CÁLCULO DOS DIAS GANHOS ---
with tab_participacao:
    render_secao_comprovantes()

# --- ABA 2: UPLOAD E EXTRAÇÃO DE PDF ---
with tab_extracao:
    # --- ÁREA DE UPLOAD ---
